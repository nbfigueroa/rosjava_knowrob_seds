...
public class GMMToOWL {
	...
	public final static String SEDS = "http://knowrob.org/kb/knowrob-seds.owl#";
	...
	private String beautifyOWL(String owl_data) {
		...
		"    <!ENTITY seds \"http://knowrob.org/kb/knowrob-seds.owl#\" >\n" +
		...
		owl_data = owl_data.replace("rdf:resource=\"http://knowrob.org/kb/knowrob-seds.owl#", 
				"rdf:resource=\"&seds;");
		owl_data = owl_data.replace("rdf:about=\"http://knowrob.org/kb/knowrob-seds.owl#", 
				"rdf:about=\"&seds;");
